...
<div id="new-comment-container" class="media-object comment-item new-comment">
	<div class="media-object-section">
		<img class="avatar" src="https://placehold.it/80x80" alt="anonymous">
	</div>
	<div class="media-object-section" style="width: 100%;">
		<label><textarea id="comment-content" name="comment-content" placeholder="Type a new comment"></textarea></label>
